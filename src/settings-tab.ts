...
export class DayPlannerSettingsTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        new Setting(containerEl)
            ...
            .setDesc('Gradient colors for the timeline (line, begin, end, hover begin, hover end, reset).')
            .addColorPicker(colorPicker => {
                colorPicker.setValue(this.plugin.settings.lineColor ?? COLORS.lineColor)
                    .onChange((value: string) => {
            ...
            .addColorPicker(colorPicker => {
                colorPicker.setValue(this.plugin.settings.timelineColorBegin ?? COLORS.timelineColorBegin)
                    .onChange((value: string) => {
            ...
            .addColorPicker(colorPicker => {
                colorPicker.setValue(this.plugin.settings.timelineColorEnd ?? COLORS.timelineColorEnd)
                    .onChange((value: string) => {
            ...
            .addColorPicker(colorPicker => {
                colorPicker.setValue(this.plugin.settings.timelineHoverColorBegin ?? COLORS.timelineHoverColorBegin)
                    .onChange((value: string) => {
            ...
            .addColorPicker(colorPicker => {
                colorPicker.setValue(this.plugin.settings.timelineHoverColorEnd ?? COLORS.timelineHoverColorEnd)
                    .onChange((value: string) => {
            ...
            .addExtraButton(button => {
                button
                    ...
                    .onClick(() => {
                        ...
                        this.plugin.settings.timelineColorBegin = COLORS.timelineColorBegin;
                        pickers.timelineColorBegin.setValue(COLORS.timelineColorBegin);

                        this.plugin.settings.timelineColorEnd = COLORS.timelineColorEnd;
                        pickers.timelineColorEnd.setValue(COLORS.timelineColorEnd);

                        this.plugin.settings.timelineHoverColorBegin = COLORS.timelineHoverColorBegin;
                        pickers.timelineHoverColorBegin.setValue(COLORS.timelineHoverColorBegin);

                        this.plugin.settings.timelineHoverColorEnd = COLORS.timelineHoverColorEnd;
                        pickers.timelineHoverColorEnd.setValue(COLORS.timelineHoverColorEnd);
